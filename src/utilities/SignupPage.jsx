...
const SignupPage = () => {
  ...
  const handleSendOtp = () => {
    if (email) {
      ...
      setOtpSent(true);
      // You can add a timer here to disable the button for a few seconds
    } else {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-5 font-sans">
      <div className="flex items-center gap-3 mb-10">
        ...
        <h1 className="text-3xl font-bold text-gray-800 m-0">Sign Up</h1>
      </div>

      <div className="bg-blue-50 rounded-xl p-8 shadow-lg w-full max-w-md">
        <form className="flex flex-col gap-6" onSubmit={handleSignup}>
          <div className="flex flex-col gap-2">
            <label htmlFor="name" className="text-sm font-medium text-gray-600 m-0">
              Name
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <button
                type="button"
                className="text-sm font-medium text-gray-600 cursor-pointer hover:text-blue-700 transition-colors duration-200"
